                ...
                <div className="max-w-2xl mx-auto relative z-10">
                    ...
                    <div className="flex items-center gap-6 bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-[32px] shadow-2xl">
                        ...
                        <div>
                            ...
                            <p className="text-white/60 text-sm mb-3">Join {reviews.length}+ happy customers who trust Lyceum for their garment care.</p>
                            <button 
                                onClick={() => navigate('/orders')}
                                className="bg-[#E85D04] hover:bg-[#d15303] text-white px-5 py-2 rounded-xl text-sm font-bold shadow-lg shadow-[#E85D04]/30 transition-all hover:scale-105 active:scale-95 flex items-center gap-2"
                            >
